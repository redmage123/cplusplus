...
// This program  is illustrating the use of destructors in multithreading.
...
class RAII_thread_example {
    ...
    thread & t;
    private:
        RAII_thread_example(const RAII_thread_example & thr); // The copy constructor
        RAII_thread_example &operator=(const RAII_thread_example &thr); // The copy assignment operator
